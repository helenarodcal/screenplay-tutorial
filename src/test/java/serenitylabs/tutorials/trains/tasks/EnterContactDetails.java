...
//    }
    public static Performable forCustomer(Customer customer) {
        return instrumented(EnterContactDetails.class, customer.getTitle(), customer.getFirstName(), customer.getLastName());
    }
